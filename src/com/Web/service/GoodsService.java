...
public class GoodsService {
    ...
    public MessageModel GoodsShow(String userName, String userPassword) {
    ...
    public MessageModel GoodsOnSale(String userName, String userPassword, String ConfirmPassword, String userEmail, String userAddress, String userPhone) {
        MessageModel messageModel = new MessageModel();
     ...
     * @return
     */
    public MessageModel updateGoodsState(String goodsId) {
        MessageModel messageModel = new MessageModel();
        ...
        Goods existingGoods = goodsMapper.selectByGoodsId(goodsId);
        ...
        // 4. 如果一切正常，则将切换物品上架状态
        try {
            int rowsAffected = goodsMapper.updateGoodsStateById(g.getGoodsId());
            session.commit();
            if (rowsAffected > 0) {
                messageModel.setCode(1);
                messageModel.setMsg("注册成功！");
